...
@Entity
@Table(name = "patient")
@NamedQuery(name = "findByIdPatient",query = "select t from PatientInfoDTO t where id=:id")
@NamedQuery(name = "findByPhysician",query = "select t from PatientInfoDTO t where physician=:physician")
