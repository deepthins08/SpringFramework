...
<li class="nav-item">
                    <a class="nav-link active text-dark fs-5 fw-bold" aria-current="page" href="Customer.jsp">Customer</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="form-floating">
  <textarea class="form-control" placeholder="Leave a comment here" value="${dto.address}" name="address" id="address" onblur="setAddress()"></textarea>
 ...
 <div class="mb-3" id="lastDonatedDiv" style="display:none;">
   ...
   <input type="date" class="form-control" id="lastDonated" name="lastDonated" disabled>
 </div>
                <div class="mb-1 mt-3">
