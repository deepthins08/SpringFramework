...
${objectError.defaultMessage}<br>
  ...
  <div class="mb-3">
                                     ...
                                     <input type="email" value="${dto.email}" class="form-control" ${action=='edit'?'readonly':''} name="email" id="email" aria-describedby="emailHelp" onblur="setMail()">
 ...
 <div class="form-group">
                ...
                <div class="mb-1 mt-3">
                 <div class="container">
                    ...
                    <c:if test="${action!='edit'}">
                                        <input type="submit" value="submit" name="submit" id="btn" class="btn btn-primary" disabled >
                                        </c:if>
 </div>
  <div class="col">
