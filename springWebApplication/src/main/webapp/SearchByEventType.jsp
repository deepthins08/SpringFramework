...
<div>
<form action="eventTypeSearch" name="form" method="get">
    <div class="container mt-5 mb-5 d-flex justify-content-center">
        <div class="card px-5 py-4 bg-light">
            <div class="card-body">

                <span class="text-success fs-4 fw-bold">${msg}</span>
                <h6 class="card-title mb-3 text-dark fs-1">Event Info</h6>

                <div class="mb-3">
                    <label for="group" class="form-label text-dark">Event Type</label>
                    <input type="text" class="form-control" name="group" id="group" aria-describedby="nameHelp" >
 ...
 <c:if test="${dto1.isEmpty()==false}">
          ...
          <thead>
            <tr>
              <th scope="col">#</th>
                           ...
                           <th scope="col">otherEventType</th>
     ...
     <c:forEach items="${dto1}" var="donar">
                  <tr>
                      ...
                      <td>${donar.name}</td>
                       <td>${donar.date}</td>
                        <td>${donar.time}</td>
                         ...
                         <td>${donar.group}</td>
                         <td>${donar.otherEventType}</td>
                         <td><a href="eventSearch?id=${donar.id}&edit=edit">Edit</a></td>
