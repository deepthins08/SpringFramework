...
<div>
<form action="transport" name="form" method="get">
    <div class="container mt-5 mb-5 d-flex justify-content-center">
        <div class="card px-5 py-4 bg-light">
            <div class="card-body">

                <span class="text-success fs-4 fw-bold">${msg}</span>
                <h6 class="card-title mb-3 text-dark fs-1">Travel Details</h6>

                <div class="mb-3">
                    <label for="group" class="form-label text-dark">Transport type</label>
                  ...
                  <tr>
                     <th scope="row">${donar.id}</th>
                                          ...
                                          <td>${donar.address}</td>
                                           <td>${donar.confirm}</td>
                                            <td>${donar.group}</td>
                                             <td>${donar.departure}</td>
                                              <td>${donar.destination}</td>
