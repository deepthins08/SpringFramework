...
<form action="patient" name="form" method="get">
    <div class="container mt-5 mb-5 d-flex justify-content-center">
        <div class="card px-5 py-4 bg-light">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label for="physician" class="form-label text-dark">Physician Name</label>
                    <input type="text" class="form-control" name="physician" id="physician" aria-describedby="nameHelp" >
