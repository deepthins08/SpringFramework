...
<div class="container">
<form action="nameSearch" name="form" method="get">
    <div class="container mt-5 mb-5 d-flex justify-content-center">
        <div class="card px-5 py-4 bg-light ">
            <div class="card-body">

                <span class="text-success fs-4 fw-bold">${error}</span><br>


                <h6 class="card-title mb-3 text-dark fs-1">Movie Name Search</h6>

 <div class="mb-3">
                     <label for="group" class="form-label text-dark">Movie Name</label>
                     <input type="text" class="form-control"  name="group" id="group" aria-describedby="ticketsHelp" >
        ...
        <tr>
              ...
              <td>${movie.date}</td>
               <td>${movie.time}</td>
                <td>${movie.tickets}</td>
                 <td>${movie.confirm}</td>
                   <td><a href="movieSearch?id=${movie.id}&edit=edit">Edit</a></td>
            </tr>
