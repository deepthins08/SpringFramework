...
<div>
<form action="hospital" name="form" method="get">
    <div class="container mt-5 mb-5 d-flex justify-content-center">
        <div class="card px-5 py-4 bg-light">
            <div class="card-body">

                <span class="text-success fs-4 fw-bold">${msg}</span>
                <h6 class="card-title mb-3 text-dark fs-1">Hospital Name</h6>

                <div class="mb-3">
                    <label for="hospital" class="form-label text-dark">Customer Name</label>
                    <input type="text" class="form-control" name="hospital" id="hospital" aria-describedby="nameHelp" >
 ...
 <c:if test="${dto1.isEmpty()==false}">
     ...
     <c:forEach items="${dto1}" var="donar">
                  <tr>
                      ...
                      <td>${donar.gender}</td>
                       <td>${donar.group}</td>
                        <td>${donar.hospital}</td>
                         <td>${donar.specialization}</td>
