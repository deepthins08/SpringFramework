...
<div>
<form action="search" name="form" method="get">
    <div class="container mt-5 mb-5 d-flex justify-content-center">
        <div class="card px-5 py-4 bg-light">
            <div class="card-body">

                <span class="text-success fs-4 fw-bold">${msg}</span>
                <h6 class="card-title mb-3 text-dark fs-1">Feedback Info</h6>

                <div class="mb-3">
                    <label for="gender" class="form-label text-dark">Customer gender</label>
                    <input type="text" class="form-control" name="gender" id="gender" aria-describedby="nameHelp" >
