           ...
           <form action="movieSearch"  method="get">
               <div class="container mt-5 mb-5 d-flex justify-content-center">
                   <div class="card px-5 py-4 bg-light">
                       <div class="card-body">
                           <span class="text-success fs-4 fw-bold">${msg}</span><br>
                           <h6 class="card-title mb-3 text-dark fs-1">Movie Ticket Booking Search</h6>
                           <div class="mb-3">
                               <label for="id" class="form-label text-dark">Id</label>
                               <input type="text" class="form-control" name="id" id="id" aria-describedby="ticketsHelp">
                           </div>
                           <div class="container">
                               <div class="row">
                                   <div class="col me-5">
